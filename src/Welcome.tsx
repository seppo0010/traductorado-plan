...
function Welcome() {
  return (
    <div>
      <h2>Bienvenide</h2>
      <p>En esta página vamos a tratar de ver en qué materia te conviene anotarte para terminar la carrera de Traductor Público en la menor cantidad de cuatrimestes.</p>
