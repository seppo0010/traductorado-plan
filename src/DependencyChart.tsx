      ...
      <div>
          ...
          <svg viewBox="0 0 1406 946" xmlns="http://www.w3.org/2000/svg">
              ...
              {Object.entries(subjectsRect).map(([key, value]) => (
                <rect key={key} x={value[0]} y={value[1]} width={value[2]} height={value[3]} fill={checked.has(key) ? 'red' : _canDo(key) ? 'yellow' : 'transparent'} fillOpacity="0.7" onClick={() => handleClick(key.toString())} cursor="pointer" />
              ))}
          </svg>
